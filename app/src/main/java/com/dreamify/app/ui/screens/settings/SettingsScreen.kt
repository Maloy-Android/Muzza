...
fun SettingsScreen(
    ...
    Column(
        ...
        Box(
            ...
            Image(
                painterResource(R.drawable.dreamify_monochrome),
...
fun VersionCard(uriHandler: UriHandler) {
    ...
    ElevatedCard(
        ...
        onClick = { uriHandler.openUri("https://github.com/Maloy-Android/Dreamify/releases/latest") }
    ) {
        Column(
            modifier = Modifier
...
fun UpdateCard(uriHandler: UriHandler) {
    ...
    if (showUpdateCard) {
        ...
        ElevatedCard(
            ...
            shape = RoundedCornerShape(38.dp),
            onClick = {
                uriHandler.openUri("https://github.com/Maloy-Android/Dreamify/releases/latest")
            }
        ) {
            Column(
                modifier = Modifier
...
suspend fun checkForUpdates(): String? = withContext(Dispatchers.IO) {
    try {
        val url = URL("https://api.github.com/repos/Maloy-Android/Dreamify/releases/latest")
